...
```bash
docker build --target development --no-cache --tag btms-connectivity-tester:development .
```

Run:

```bash
docker run -p 3000:3000 btms-connectivity-tester:development
```
...
```bash
docker build --no-cache --tag btms-connectivity-tester .
```

Run:

```bash
docker run -p 3000:3000 btms-connectivity-tester
```
